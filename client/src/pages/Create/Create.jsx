...
function Create({ playlist, setPlaylist, updatePlaylist, handleDelete, anyStylerOpen, setAnyStylerOpen, search, setSearch, fullBackground, setFullBackground, state, dispatch, selectedForStyling, setSelectedForStyling, isSaveModalOpen, setIsSaveModalOpen }) {
    return (
        <>
        ...
        <main style={{minHeight: '90vh'}}>
            ...
            <SaveModal isSaveModalOpen={isSaveModalOpen} setIsSaveModalOpen={setIsSaveModalOpen} playlist={playlist}/>
        </main>
        </>
        )
}
